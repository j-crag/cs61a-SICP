...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    number_of_pi_trims = 101 - (score + 1)
    while number_of_pi_trims:
        pi = pi // 10
        number_of_pi_trims -= 1
    return pi % 10 + 3
...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    divisor = min(player_score, opponent_score)
    while divisor:
        if (
            player_score % divisor == 0 and opponent_score % divisor == 0
        ) and divisor >= 10:
            return True
        divisor -= 1
    return False
...
def play(
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            while (extra_roll and (score0 < goal and score1 < goal)):
                num_rolls = strategy0(score0, score1)
                score0 += take_turn(num_rolls, score1, dice)
                say = say(score0, score1)
                extra_roll = extra_turn(score0, score1)
        ...
        if who == 1:
            ...
            while(extra_roll and (score1 < goal and score0 < goal)):
                num_rolls = strategy1(score1 ,score0)
                score1 += take_turn(num_rolls, score0, dice)
                say = say(score0, score1)
                extra_roll = extra_turn(score1, score0)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            curr_high_roll = running_high
            if this_roll_score > curr_high_roll:
                curr_high_roll = this_roll_score
                print(curr_high_roll, "point(s)! The most yet for Player", who)
        else:
            this_roll_score = score1 - last_score
            curr_high_roll = running_high
            if this_roll_score > curr_high_roll:
                curr_high_roll = this_roll_score
                print(curr_high_roll, "point(s)! The most yet for Player", who)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    1
 """
    count, max_ave, max_ave_roll_num = 1, 0, 1
    max_ave = 0
    max_ave_roll_num = 1
    while count <= 10:
        averaged_roll_dice = make_averaged(roll_dice, trials_count)
        current_roll_ave = averaged_roll_dice(count, dice)
        if current_roll_ave > max_ave:
            max_ave = current_roll_ave
            max_ave_roll_num = count
        count += 1
    return max_ave_roll_num
   # END PROBLEM 9
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    extra_roll = extra_turn(score + free_bacon(opponent_score), opponent_score)
    if extra_roll:
        return 0 
...
def final_strategy(score, opponent_score):
    ...
    shoot for the moon, always roll 10!
    """
